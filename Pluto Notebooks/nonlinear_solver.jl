...
begin
	...
	N = 2^8;
	beam_width = 0.5e-3;
	xv = 3*beam_width*range(-1,1,length=N);
	yv = 3*beam_width*range(-1,1,length=N);
	zc = 50e-2;
	...
	xₒ₁ = beam_width*randn(num_instances);
	xₒ₂ = beam_width*randn(num_instances);
	yₒ₁ = beam_width*randn(num_instances);
	yₒ₂ = beam_width*randn(num_instances);
...
manifest_format = "2.0"
project_hash = "632c057a8b0067dd972b9e60d6e4b14ada0c09c5"
